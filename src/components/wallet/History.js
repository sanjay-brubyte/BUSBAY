...
//         alignItems="center"
//         mb={2}
//         sx={{ borderBottom: '3px solid blue', pb: 1 }}
//       >
//         <Typography variant="h6" fontWeight={600}>
//           History
//         </Typography>
...
const rowsData = [
  { id: 1, type: "Deposit", network: "Bitcoin", amount: "4 BTC", txHash: "A1B2C3D4E5F6", status: "Success", date: "2025-05-30" },
  { id: 2, type: "Withdrawal", network: "Ethereum", amount: "1.02 ETH", txHash: "B2C3D4E5F6A1", status: "Processing", date: "2025-06-01" },
  { id: 3, type: "Transfer", network: "Litecoin", amount: "20 LTC", txHash: "C3D4E5F6A1B2", status: "Failed", date: "2025-06-02" },
  { id: 4, type: "Withdrawal", network: "Bitcoin", amount: "0.5 BTC", txHash: "D4E5F6A1B2C3", status: "Pending", date: "2025-06-03" },
  { id: 5, type: "Deposit", network: "Ripple", amount: "3000 XRP", txHash: "E5F6A1B2C3D4", status: "Success", date: "2025-06-04" },
  { id: 6, type: "Transfer", network: "Ethereum", amount: "2 ETH", txHash: "F6A1B2C3D4E5", status: "Processing", date: "2025-06-05" },
  { id: 7, type: "Deposit", network: "Bitcoin Cash", amount: "5 BCH", txHash: "A7B8C9D0E1F2", status: "Success", date: "2025-06-06" },
  { id: 8, type: "Withdrawal", network: "Litecoin", amount: "10 LTC", txHash: "B8C9D0E1F2A3", status: "Failed", date: "2025-06-07" },
  { id: 9, type: "Transfer", network: "Ripple", amount: "1500 XRP", txHash: "C9D0E1F2A3B4", status: "Pending", date: "2025-06-08" },
  { id: 10, type: "Deposit", network: "Ethereum", amount: "3 ETH", txHash: "D0E1F2A3B4C5", status: "Success", date: "2025-06-09" },
];
  ...
  return (
    <Box p={3}>
      <Box
        ...
        alignItems="center"
        mb={2}
        sx={{ borderBottom: "2px solid blue", pb: 1 }}
      >
        <Typography
          sx={{
            fontFamily: "Bai Jamjuree",
      ...
      <TableContainer component={Paper} sx={{ boxShadow: "none" }}>
        <Table>
          <TableHead>
            <TableRow>
              {["Order", "Type", "Network", "Amount", "TX Hash", "Status", "Date"].map(
                (head) => (
                  <TableCell
                    key={head}
                    sx={{
