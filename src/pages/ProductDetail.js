...
const allProducts = [
  // ürünler burada...
  // (kısaca önceki listenizi tekrar ediyorum)
  {
    id: 1,
    name: 'Galaxy A54 5G 128GB',
    description: `• Access Smart TV Apps Without Your PC Or Laptop<br />
...
• Work Seamlessly With Microsoft 365 Or Use Remote PC To Work On Your School Or Office PC`,
  ...
  // ... diğer ürünler
  // (düzenli liste burada devam ediyor)
];
          ...
          <Box display="flex" alignItems="center" mt={3} gap={2}>
            ...
            >
              <Button
                variant="outlined"
                onClick={() => setQuantity((prev) => Math.max(1, prev - 1))}
                sx={{ minWidth: 36, borderRight: 'none' }}
              >
                –
              </Button>
              <TextField
              ...
              <Button
                ...
                sx={{ minWidth: 36, borderLeft: 'none' }}
              >
                +
              </Button>
            </Box>
                ...
                <Grid item xs={12} md={8}>
                  {[
                    ...
                    <Box key={index} display="flex" alignItems="center" mb={1}>
                      ...
                      <Box flexGrow={1} mx={1} height={10} borderRadius={5} bgcolor="#e0e0e0" display="flex" alignItems="center">
                        <Box
                          width={`${item.value}%`}
                          height="100%"
                          bgcolor="#fdd835"
